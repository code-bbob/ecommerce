...
export function SingleBlog() {
  ...
  return (
    ...
    {/* <!-- Topic Nav --> */}
    <nav className="w-full py-4 border-t border-b bg-black">
               
        <div className="w-full flex-grow sm:flex sm:items-center sm:w-auto">
            <div className="w-full container mx-auto flex flex-col sm:flex-row items-center justify-center text-sm font-bold uppercase mt-0 px-6 py-2">
                <a href="#" className="hover:bg-gray-400 no-underline text-white hover:underline rounded py-2 px-4 mx-2">Technology</a>
                <a href="#" className="hover:bg-gray-400 no-underline text-white hover:underline rounded py-2 px-4 mx-2">Automotive</a>
                <a href="#" className="hover:bg-gray-400 no-underline text-white hover:underline rounded py-2 px-4 mx-2">Finance</a>
                <a href="#" className="hover:bg-gray-400 no-underline text-white hover:underline rounded py-2 px-4 mx-2">Politics</a>
                <a href="#" className="hover:bg-gray-400 no-underline text-white hover:underline rounded py-2 px-4 mx-2">Culture</a>
                <a href="#" className="hover:bg-gray-400 no-underline text-white hover:underline rounded py-2 px-4 mx-2">Sports</a>
            </div>
        </div>
    </nav>
